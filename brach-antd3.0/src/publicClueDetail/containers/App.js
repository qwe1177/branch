...
class App extends Component {
    ...
    render() {
        ...
        switch (this.props.supplierDetailMain.data.qualityControlId) {
            case '0':
            case '4':
                ispkval = <Button type="primary" className='normal' onClick={this.tourl('/qualitycontrol/tosubmit/')}>提交品控</Button>;
                break;
            case '1':
                ispkval = <Button type="primary" className='normal' onClick={this.pkmodal}>取消品控</Button>;
                break;
            case '3':
                ispkval = <Button type="primary" className='normal' onClick={this.tourl('/qualitycontrol/retosubmit/')}>重新提交品控</Button>;
                break;
        }
