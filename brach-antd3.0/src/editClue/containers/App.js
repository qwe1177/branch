...
import CategorySelector from '../../components/business/categoryselectornew/index';
import BrandSelector from '../../components/business/brandselectornew/index';
...
class UserForm extends Component {
    ...
    handleOpenChoose = (name, id) => () => {
        ...
        this.brandSelector.setVisible(true);
    }
    handleOpenChooseForCategory = () => {
        // this.setState({ categorySelectorVisible: true });
        this.categorySelector.setVisible(true);
    }
    ...
    handleChoosedForCategory = (ids, labels) => {
        ...
        this.categorySelector.setVisible(false);
    }
                                    ...
                                    <div className="content">
                                        ...
                                        <Row style={{ 'padding': '8px 0px' }}>
                                            ...
                                            <Col span={12} style={{ textAlign: 'left' }}>
                                                ...
                                                <CategorySelector
                                                    onChoosed={this.handleChoosedForCategory}
                                                    choosedKeys={choosedKeys1}
                                                    ref={(selector) => { this.categorySelector = selector; }}
                                        ...
                                        <Row style={{ 'padding': '8px 0px' }}>
                                            <Col span={12} style={{ textAlign: 'left' }}>
                                                ...
                                                <BrandSelector
                                                    onChoosed={this.handleChoosed}
                                                    choosedKeys={choosedKeys}
                                                    type={this.state.Selectortype}
                                                    ref={(selector) => { this.brandSelector = selector; }}
                                                />
