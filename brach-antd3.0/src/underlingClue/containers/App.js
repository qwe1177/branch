    ...
    constructor(props) {
        ...
        this.columns = [{
            ...
            render: (text, record, index) => {
                ...
                const url = `/underlingClueDetail/?supplierId=${record.supplierId}&systemId=${systemId}&moduleId=${moduleId}`
        ...
        axios.get(url, {
            ...
            if (response.status == 200) {
                if (response.data.code == 1) {
                    ...
                    this.props.fetchPosts({key: 'data', value: {isPass: 'no', markToDistinguish: 'underling'}})
                    setTimeout(() => {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                newobj.isPass = 'no';
                newobj.markToDistinguish = 'underling';
