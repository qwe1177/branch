...
class QuoteFrom2 extends React.Component {
    state = {
    ...
    render() {
      return (
			<div className="pd20">
				<div className="tit"><div className="g-fl"><a href="javascript:;">刷新列表</a></div><div className="g-fl g-ml">删除</div> </div>
