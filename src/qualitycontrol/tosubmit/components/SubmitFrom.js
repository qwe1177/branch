        ...
        fetchInitInfo(supplierId).then((res) => {
            if (res.data.code = '1') {
                const {
                    ...
                    , undertaking, officespace, workshop, brankName, brankType, authorization, registration, certification, otherAptitude, remark, supplierBrankList,
                    harea, hvenue, hfloor, hdistrict, provincebase, citybase, countybase, townbase
                } = res.data.data;

                this.props.baseInfoForm({ companyName, companyAddress });
        ...
        return (
            <Form layout="horizontal" onSubmit={this.handleSubmit} className="main-submit-form">
                ...
                <div className="tabel-wrap">
                    <div className="audit-tit"> 营业品控资料 </div>
                    <Row gutter={24}>
                        <Col span={12}>
                            ...
                            >
                                {getFieldDecorator('corporation', {
                                    ...
                                    <Input placeholder="企业法人"
                                        style={{ width: '60%', 'marginRight': '10px' }} maxLength='20' />
                                    )}
                ...
                <div className="tabel-wrap">
                    ...
                    <div className='section-wrap alignment-bottom'>
                        <Table pagination={false} columns={columns} dataSource={data1} bordered className="g-mt"
                ...
                <div className="tabel-wrap">
                    <div className="audit-tit"><span> 产品报价</span> <span className='refresh-table-btn' onClick={this.refreshTable}> 刷新列表 </span></div>
